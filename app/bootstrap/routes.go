...
func RegisterRoutes(e *echo.Echo, usersHandler *usersFeature.Handler, tokenMaker token.Maker, hashFn func(ctx context.Context, userID uuid.UUID) (string, error)) {
